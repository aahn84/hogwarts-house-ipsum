function CupcakeIpsumController(e, t, n, r) {
  this.paragraphs = [], this.paragraphGenerator = n, this.randomEngine = r, this.wordGenerator = t, this.generateParagraphs(), this.ipsumShareUrl = "http://cupcakeipsum.com/#" + e.hashPath, this.ipsumShareText = encodeURIComponent("Here's the sweetest lorem ipsum I've ever seen: " + this.ipsumShareUrl + " by the nerd loving girls at @unerdwear")
}

function CupcakeIpsumFormController(e, t) {
  this.numberOfParagraphs = this.numberOfParagraphs || 5, this.lengthOfParagraph = this.lengthOfParagraph || "long", this.startsWithCupcakeIpsum = this.startsWithCupcakeIpsum || !1, this.containsLove = this.containsLove || !1, this.$location = e, this.randomEngine = t, this.updateBodyClass()
}! function(e, t) {
  ...
  function S(e) {
    var t = ht,
      n = Kt[e];
    return n || (n = E(e, t), "none" !== n && n || (Qt = (Qt || it("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = (Qt[0].contentWindow || Qt[0].contentDocument).document, t.write(), t.close(), n = E(e, t), Qt.detach()), Kt[e] = n), n
  }
  ...
  function A(e, t) {
    for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) r = e[a], r.style && (o[a] = it._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && At(r) && (o[a] = it._data(r, "olddisplay", S(r.nodeName)))) : (i = At(r), (n && "none" !== n || !i) && it._data(r, "olddisplay", i ? n : it.css(r, "display"))));
  ...
  function q(e, t, n) {
    ...
    })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], l = it.css(e, "display"), c = "none" === l ? it._data(e, "olddisplay") || S(e.nodeName) : l, "inline" === c && "none" === it.css(e, "float") && (nt.inlineBlockNeedsLayout && "inline" !== S(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")), n.overflow && (p.overflow = "hidden", nt.shrinkWrapBlocks() || d.always(function() {
    ...
    if (it.isEmptyObject(f)) "inline" === ("none" === l ? S(e.nodeName) : l) && (p.display = l);
    else {
  ...
  it.fn = it.prototype = {
    ...
    proxy: function(e, t) {
      var n, r, i;
      return "string" == typeof t && (i = e[t], t = e, e = i), it.isFunction(e) ? (n = Z.call(arguments, 2), r = function() {
  ...
  var lt = function(e) {
    function t(e, t, n, r) {
      ...
      if ((t ? t.ownerDocument || t : $) !== H && L(t), t = t || H, n = n || [], s = t.nodeType, "string" != typeof e || !e || 1 !== s && 9 !== s && 11 !== s) return n;
      if (!r && _) {
        if (11 !== s && (i = yt.exec(e)))
          if (a = i[1]) {
            if (9 === s) {
        ...
        if (w.qsa && (!M || !M.test(e))) {
          if (p = d = R, h = t, m = 1 !== s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
            for (l = S(e), (d = t.getAttribute("id")) ? p = d.replace(xt, "\\$&") : t.setAttribute("id", p), p = "[id='" + p + "'] ", u = l.length; u--;) l[u] = p + f(l[u]);
    ...
    var x, w, C, T, E, S, k, N, A, j, D, L, H, O, _, M, q, P, F, R = "sizzle" + 1 * new Date,
      $ = e.document,
      I = 0,
      B = 0,
      W = n(),
    ...
    try {
      Q.apply(Z = K.call($.childNodes), $.childNodes), Z[$.childNodes.length].nodeType
    } catch (Et) {
      Q = {
    ...
    w = t.support = {}, E = t.isXML = function(e) {
      ...
      return r !== H && 9 === r.nodeType && r.documentElement ? (H = r, O = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Tt, !1) : n.attachEvent && n.attachEvent("onunload", Tt)), _ = !E(r), w.attributes = i(function(e) {
      ...
      }, q = [], M = [], (w.qsa = vt.test(r.querySelectorAll)) && (i(function(e) {
      ...
      })), (w.matchesSelector = vt.test(P = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && i(function(e) {
        w.disconnectedMatch = P.call(e, "div"), P.call(e, "[s!='']:x"), q.push("!=", at)
      }), M = M.length && new RegExp(M.join("|")), q = q.length && new RegExp(q.join("|")), t = vt.test(O.compareDocumentPosition), F = t || vt.test(O.contains) ? function(e, t) {
        ...
        return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === r || e.ownerDocument === $ && F($, e) ? -1 : t === r || t.ownerDocument === $ && F($, t) ? 1 : j ? et(j, e) - et(j, t) : 0 : 4 & n ? -1 : 1)
      } : function(e, t) {
        if (e === t) return D = !0, 0;
        var n, i = 0,
          o = e.parentNode,
          ...
          u = [e],
          l = [t];
        if (!o || !s) return e === r ? -1 : t === r ? 1 : o ? -1 : s ? 1 : j ? et(j, e) - et(j, t) : 0;
        if (o === s) return a(e, t);
      ...
      if ((e.ownerDocument || e) !== H && L(e), n = n.replace(dt, "='$1']"), !(!w.matchesSelector || !_ || q && q.test(n) || M && M.test(n))) try {
        var r = P.call(e, n);
      ...
      var n = C.attrHandle[t.toLowerCase()],
        r = n && V.call(C.attrHandle, t.toLowerCase()) ? n(e, t, !_) : void 0;
          ...
          return 1 === r && 0 === i ? function(e) {
            ...
            if (g) {
              ...
              if (h = [a ? g.firstChild : g.lastChild], a && y) {
                for (c = g[R] || (g[R] = {}), l = c[e] || [], p = l[0] === I && l[1], f = l[0] === I && l[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop();)
                  if (1 === d.nodeType && ++f && d === t) {
                    c[e] = [I, p, f];
                    break
                  }
              } else if (y && (l = (t[R] || (t[R] = {}))[e]) && l[0] === I) f = l[1];
              else
                for (;
                  (d = ++p && d && d[m] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[R] || (d[R] = {}))[e] = [I, f]), d !== t)););
    ...
    return d.prototype = C.filters = C.pseudos, C.setFilters = new d, S = t.tokenize = function(e, n) {
      ...
      if (n = n || [], 1 === d.length) {
        if (o = d[0] = d[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && w.getById && 9 === t.nodeType && _ && C.relative[o[1].type]) {
  ...
  it.event = {
    ...
    fix: function(e) {
      ...
      var t, n, r, i = e.type,
        o = e,
        a = this.fixHooks[i];
      for (a || (this.fixHooks[i] = a = Ot.test(i) ? this.mouseHooks : Ht.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new it.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
  ...
  var qt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
    ...
    Jt = m(ht),
    Yt = Jt.appendChild(ht.createElement("div"));
  Zt.optgroup = Zt.option, Zt.tbody = Zt.tfoot = Zt.colgroup = Zt.caption = Zt.thead, Zt.th = Zt.td, it.extend({
    clone: function(e, t, n) {
      var r, i, o, a, s, u = it.contains(e.ownerDocument, e);
      if (nt.html5Clone || it.isXMLDoc(e) || !Ft.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Yt.innerHTML = e.outerHTML, Yt.removeChild(o = Yt.firstChild)), !(nt.noCloneEvent && nt.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || it.isXMLDoc(e)))
    ...
    buildFragment: function(e, t, n, r) {
      for (var i, o, a, s, u, l, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)
        ...
        for (s = s || f.appendChild(t.createElement("div")), u = (It.exec(o) || ["", ""])[1].toLowerCase(), c = Zt[u] || Zt._default, s.innerHTML = c[1] + o.replace($t, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
        if (!nt.leadingWhitespace && Rt.test(o) && p.push(t.createTextNode(Rt.exec(o)[0])), !nt.tbody)
          for (o = "table" !== u || Bt.test(o) ? "<table>" !== c[1] || Bt.test(o) ? 0 : s : s.firstChild, i = o && o.childNodes.length; i--;) it.nodeName(l = o.childNodes[i], "tbody") && !l.childNodes.length && o.removeChild(l);
    ...
    cleanData: function(e, t) {
      for (var n, r, i, o, a = 0, s = it.expando, u = it.cache, l = nt.deleteExpando, c = it.event.special; null != (n = e[a]); a++)
        if ((t || it.acceptData(n)) && (i = n[s], o = i && u[i])) {
          ...
          u[i] && (delete u[i], l ? delete n[s] : typeof n.removeAttribute !== Tt ? n.removeAttribute(s) : n[s] = null, V.push(i))
        }
    }
  }), it.fn.extend({
    text: function(e) {
    ...
    html: function(e) {
      return jt(this, function(e) {
        ...
        if (!("string" != typeof e || zt.test(e) || !nt.htmlSerialize && Ft.test(e) || !nt.leadingWhitespace && Rt.test(e) || Zt[(It.exec(e) || ["", ""])[1].toLowerCase()])) {
          e = e.replace($t, "<$1></$2>");
          try {
    ...
    style: function(e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i, o, a, s = it.camelCase(t),
          u = e.style;
        if (t = it.cssProps[s] || (it.cssProps[s] = N(u, s)), a = it.cssHooks[t] || it.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t];
  ...
  it.fn.extend({
    ...
    attr: function(e, t, n) {
      var r, i, o = e.nodeType;
      if (e && 3 !== o && 8 !== o && 2 !== o) return typeof e.getAttribute === Tt ? it.prop(e, t, n) : (1 === o && it.isXMLDoc(e) || (t = t.toLowerCase(), r = it.attrHooks[t] || (it.expr.match.bool.test(t) ? Tn : Cn)), void 0 === n ? r && "get" in r && null !== (i = r.get(e, t)) ? i : (i = it.find.attr(e, t), null == i ? void 0 : i) : null !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : void it.removeAttr(e, t))
    },
    removeAttr: function(e, t) {
      var n, r, i = 0,
        o = t && t.match(bt);
      if (o && 1 === e.nodeType)
        for (; n = o[i++];) r = it.propFix[n] || n, it.expr.match.bool.test(n) ? Nn && kn || !Sn.test(n) ? e[r] = !1 : e[it.camelCase("default-" + n)] = e[r] = !1 : it.attr(e, n, ""), e.removeAttribute(kn ? n : r)
    },
    attrHooks: {
      type: {
        set: function(e, t) {
    ...
    set: function(e, t, n) {
      return t === !1 ? it.removeAttr(e, n) : Nn && kn || !Sn.test(n) ? e.setAttribute(!kn && it.propFix[n] || n, n) : e[it.camelCase("default-" + n)] = e[n] = !0, n
    }
  }, it.each(it.expr.match.bool.source.match(/\w+/g), function(e, t) {
    var n = En[t] || it.find.attr;
    En[t] = Nn && kn || !Sn.test(t) ? function(e, t, r) {
      var i, o;
  ...
  _n = Bn.exec(Mn.toLowerCase()) || [], it.extend({
    active: 0,
    lastModified: {},
    etag: {},
    ajaxSettings: {
    ...
    ajax: function(e, t) {
      function n(e, t, n, r) {
        var i, c, v, y, x, C = t;
        2 !== b && (b = 2, s && clearTimeout(s), l = void 0, a = r || "", w.readyState = e > 0 ? 4 : 0, i = e >= 200 && 300 > e || 304 === e, n && (y = B(d, w, n)), y = W(d, y, w, i), i ? (d.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (it.lastModified[o] = x), x = w.getResponseHeader("etag"), x && (it.etag[o] = x)), 204 === e || "HEAD" === d.type ? C = "nocontent" : 304 === e ? C = "notmodified" : (C = y.state, c = y.data, v = y.error, i = !v)) : (v = C, (e || !C) && (C = "error", 0 > e && (e = 0))), w.status = e, w.statusText = (t || C) + "", i ? h.resolveWith(f, [c, C, w]) : h.rejectWith(f, [w, C, v]), w.statusCode(g), g = void 0, u && p.trigger(i ? "ajaxSuccess" : "ajaxError", [w, d, i ? c : v]), m.fireWith(f, [w, C]), u && (p.trigger("ajaxComplete", [w, d]), --it.active || it.event.trigger("ajaxStop")))
      }
      ...
      if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || Mn) + "").replace(qn, "").replace(In, _n[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = it.trim(d.dataType || "*").toLowerCase().match(bt) || [""], null == d.crossDomain && (r = Bn.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === _n[1] && r[2] === _n[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (_n[3] || ("http:" === _n[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = it.param(d.data, d.traditional)), $(Wn, d, t, w), 2 === b) return w;
  ...
  it.param = function(e, t) {
    ...
    serializeArray: function() {
      return this.map(function() {
        ...
        var e = this.type;
        return this.name && !it(this).is(":disabled") && Yn.test(this.nodeName) && !Jn.test(e) && (this.checked || !Dt.test(e))
      }).map(function(e, t) {
        var n = it(this).val();
  ...
  it.offset = {
    ...
    offset: function(e) {
      ...
      var t, n, r = {
        ...
        i = this[0],
        o = i && i.ownerDocument;
      if (o) return t = o.documentElement, it.contains(t, i) ? (typeof i.getBoundingClientRect !== Tt && (r = i.getBoundingClientRect()), n = G(o), {
...
function(e, t, n, r, i, o, a) {
  function s(e) {
    var t, r, i = this,
      ...
      a = 0,
      s = i.i = i.j = i.m = 0;
    for (i.S = [], i.c = [], o || (e = [o++]); n > a;) i.S[a] = a++;
    for (a = 0; n > a; a++) t = i.S[a], s = c(s + t + e[a % o]), r = i.S[s], i.S[a] = r, i.S[s] = t;
    i.g = function(e) {
      var t = i.S,
        r = c(i.i + 1),
        o = t[r],
        ...
        s = t[a];
      t[r] = s, t[a] = o;
      for (var u = t[c(o + s)]; --e;) r = c(r + 1), o = t[r], a = c(a + o), s = t[a], t[r] = s, t[a] = o, u = u * n + t[c(o + s)];
      return i.i = r, i.j = a, u
    }, i.g(n)
  }

  function u(e, t, n, r, i) {
    if (n = [], i = typeof e, t && "object" == i)
      for (r in e)
        if (r.indexOf("S") < 5) try {
          n.push(u(e[r], t - 1))
        } catch (o) {}
    return n.length ? n : e + ("string" != i ? "\x00" : "")
  }

  function l(e, t, n, r) {
    for (e += "", n = 0, r = 0; r < e.length; r++) t[c(r)] = c((n ^= 19 * t[c(r)]) + e.charCodeAt(r));
    e = "";
  ...
  t.seedrandom = function(c, d) {
    var f, p = [];
    return c = l(u(d ? [c, e] : arguments.length ? c : [(new Date).getTime(), e, window], 3), p), f = new s(p), l(f.S, e), t.random = function() {
      for (var e = f.g(r), t = a, s = 0; i > e;) e = (e + s) * n, t *= n, s = f.g(1);
      for (; e >= o;) e /= 2, t /= 2, s >>>= 1;
      return (e + s) / t
    }, c
  }, a = t.pow(n, r), i = t.pow(2, i), o = 2 * i, l(t.random(), e)
}([], Math, 256, 6, 52);
var Sha256 = {};
Sha256.hash = function(e, t) {
  t = "undefined" == typeof t ? !0 : t, t && (e = Utf8.encode(e));
  ...
  for (var i = e.length / 4 + 2, o = Math.ceil(i / 16), a = new Array(o), s = 0; o > s; s++) {
    a[s] = new Array(16);
  ...
  for (var l, c, d, f, p, h, m, g, v = new Array(64), s = 0; o > s; s++) {
    for (var y = 0; 16 > y; y++) v[y] = a[s][y];
    for (var y = 16; 64 > y; y++) v[y] = Sha256.sigma1(v[y - 2]) + v[y - 7] + Sha256.sigma0(v[y - 15]) + v[y - 16] & 4294967295;
    l = r[0], c = r[1], d = r[2], f = r[3], p = r[4], h = r[5], m = r[6], g = r[7];
    for (var y = 0; 64 > y; y++) {
      var b = g + Sha256.Sigma1(p) + Sha256.Ch(p, h, m) + n[y] + v[y],
        x = Sha256.Sigma0(l) + Sha256.Maj(l, c, d);
      g = m, m = h, h = p, p = f + b & 4294967295, f = d, d = c, c = l, l = b + x & 4294967295
    }
    r[0] = r[0] + l & 4294967295, r[1] = r[1] + c & 4294967295, r[2] = r[2] + d & 4294967295, r[3] = r[3] + f & 4294967295, r[4] = r[4] + p & 4294967295, r[5] = r[5] + h & 4294967295, r[6] = r[6] + m & 4294967295, r[7] = r[7] + g & 4294967295
  }
...
var ZeroClipboard = {
  ...
  $: function(e) {
    return "string" == typeof e && (e = document.getElementById(e)), e.addClass || (e.hide = function() {
      ...
      for (var t = this.className.split(/\s+/), n = -1, r = 0; r < t.length; r++) t[r] == e && (n = r, r = t.length);
...
ZeroClipboard.Client.prototype = {
  ...
  glue: function(e, t, n) {
    ...
    var r = 99;
    this.domElement.style.zIndex && (r = parseInt(this.domElement.style.zIndex, 10) + 1), "string" == typeof t ? t = ZeroClipboard.$(t) : "undefined" == typeof t && (t = document.getElementsByTagName("body")[0]);
    var i = ZeroClipboard.getDOMObjectPosition(this.domElement, t);
    this.div = document.createElement("div");
    var o = this.div.style;
    if (o.position = "absolute", o.left = "" + i.left + "px", o.top = "" + i.top + "px", o.width = "" + i.width + "px", o.height = "" + i.height + "px", o.zIndex = r, "object" == typeof n)
  ...
  receiveEvent: function(e, t) {
    ...
    if (this.handlers[e])
      for (var r = 0, i = this.handlers[e].length; i > r; r++) {
...
}, angular.service("app", function(e, t) {
  e.when("/paragraphs/:numberOfParagraphs/length/:lengthOfParagraph/with_love/:containsLove/start_with_cupcake/:startsWithCupcake/seed/:seed", {
    template: "partials/partial1.html",
    controller: CupcakeIpsumController
  });
  var n = this;
  e.onChange(function() {
    null === e.current ? (t.updateHash(""), n.$eval()) : e.current.scope.params = e.current.params
  })
}, {
  $inject: ["$route", "$location", "$window"],
  $eager: !0
}), angular.service("paragraphGenerator", function(e, t) {
  return {
    generate: function(n) {
      for (var r = {
          "long": [12, 15],
          medium: [6, 11],
          "short": [3, 5]
        }, i = r[n] || r["long"], o = t.generateIntegerBetween(i[0], i[1]), a = [], s = 0; o > s; ++s) a.push(e.generateSentence());
      return a.join(" ")
    }
  }
}, {
  $inject: ["sentenceGenerator", "randomizer"]
}), angular.service("randomEngine", function() {
  return {
    random: function() {
      return Math.random()
    },
    seed: function(e) {
      return e ? Math.seedrandom(e) : Sha256.hash(Math.seedrandom())
    }
  }
}), angular.service("randomizer", function(e) {
  return {
    generateIntegerBetween: function(t, n) {
      return Math.floor(t + (n - t) * e.random())
    }
  }
}, {
  $inject: ["randomEngine"]
}), angular.service("sentenceGenerator", function(e, t) {
  return {
    generateSentence: function(n) {
      n = t.generateIntegerBetween(3, 10);
      for (var r = [], i = 0; n > i; ++i) r.push(e.generateWord());
      var o = r.join(" ") + ".";
      return o = o.charAt(0).toUpperCase() + o.substr(1)
    }
  }
}, {
  $inject: ["wordGenerator", "randomizer"]
}), angular.service("wordGenerator", function(e, t) {
  var n = [],
    r = 0;
  return {
    startWithCupcakeIpsum: function() {
      n = ["amet", "sit", "dolor", "ipsum", "cupcake"]
    },
    setChanceOfLove: function(e) {
      r = e
    },
    generateWord: function() {
      if (n.length > 0) return n.pop();
      if (r >= t.generateIntegerBetween(1, 100)) return "I love";
      var i = t.generateIntegerBetween(0, e.wordsCount() - 1);
      return e.getWord(i)
    }
  }
}, {
  $inject: ["wordProvider", "randomizer"]
}), angular.service("wordProvider", function() {
  var e = ["cupcake", "cake", "candy", "pastry", "sweet", "cookie", "ice cream", "pie", "pudding", "tart", "croissant", "sweet roll", "muffin", "lollipop", "caramels", "lemon drops", "toffee", "chocolate", "jujubes", "jelly", "jelly beans", "marshmallow", "marzipan", "halvah", "gummies", "gummi bears", "tootsie roll", "liquorice", "chupa chups", "bonbon", "dessert", "sugar plum", "drag\xe9e", "apple pie", "biscuit", "wafer", "chocolate bar", "candy canes", "gingerbread", "donut", "cheesecake", "oat cake", "carrot cake", "fruitcake", "souffl\xe9", "tiramisu", "chocolate cake", "brownie", "macaroon", "icing", "powder", "topping", "jelly-o", "cake", "sesame snaps", "danish", "bear claw", "cotton candy", "caramel corn"];
  return {
    getWord: function(t) {
      return e[t]
    },
...
}), CupcakeIpsumController.prototype.generateParagraphs = function() {
  this.randomEngine.seed(this.params.seed), "true" == this.params.startsWithCupcake && this.wordGenerator.startWithCupcakeIpsum(), this.wordGenerator.setChanceOfLove("true" == this.params.containsLove ? 10 : 0), this.paragraphs = [];
  for (var e = 0; e < this.params.numberOfParagraphs; e++) {
    var t = {
      text: this.paragraphGenerator.generate(this.params.lengthOfParagraph)
    };
    this.paragraphs.push(t)
  }
}, CupcakeIpsumController.prototype.getParagraphsAsPlainText = function() {
  for (var e = "", t = 0; t < this.paragraphs.length; ++t) e += 0 == t ? "" : "\n", e += this.paragraphs[t].text;
  return e
}, CupcakeIpsumController.$inject = ["$location", "wordGenerator", "paragraphGenerator", "randomEngine"], CupcakeIpsumFormController.prototype.generateParagraphs = function() {
  var e = "/paragraphs/" + this.numberOfParagraphs + "/length/" + this.lengthOfParagraph + "/with_love/" + this.containsLove + "/start_with_cupcake/" + this.startsWithCupcakeIpsum + "/seed/" + this.randomEngine.seed();
  this.$location.updateHash(e), this.updateBodyClass(), _gaq.push(["_trackEvent", "generate_ipsum_button", "clicked"])
}, CupcakeIpsumFormController.prototype.updateBodyClass = function() {
  this.bodyClass = "" == this.$location.hashPath ? "short" : ""
}, CupcakeIpsumFormController.prototype.navigateToMain = function() {
  this.$location.updateHash(""), this.updateBodyClass(), _gaq.push(["_trackEvent", "logo", "clicked"])
}, CupcakeIpsumFormController.$inject = ["$location", "randomEngine"], angular.directive("app:clipboard", function(e) {
  return ZeroClipboard.setMoviePath("ZeroClipboard.swf"),
    function(t) {
      var n = new ZeroClipboard.Client;
      n.setHandCursor(!0), n.setCSSEffects(!0), n.setText("");
      var r = this;
      n.addEventListener("onMouseDown", function(t) {
        var n = r.$eval(e);
        t.setText(n)
...
}), angular.widget("app:twitter_button", function(e) {
  var t = e.attr("text"),
    n = e.attr("count");
  return function(e) {
    var r = this;
    r.$watch(t, function(t) {
      var r = "//platform.twitter.com/widgets/tweet_button.html?text=" + t + "&count=" + n + "&url=null";
      $(e).empty().append($('<iframe allowtransparency="true" frameborder="0" scrolling="no" src="' + r + '" style="width:55px; height:62px;"></iframe>'))
    })
  }
}), angular.widget("app:google_button", function(e) {
  var t = e.attr("href"),
    n = e.attr("size"),
    r = e.attr("annotation");
  return function(e) {
    ...
    i.$watch(t, function(t) {
      $(e).empty().append('<g:plusone size="' + n + '" annotation="' + r + '" href="' + t + '"></g:plusone>')
    })
  }
});
